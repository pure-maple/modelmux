...
Usage:
    modelmux benchmark                    # all available providers
    modelmux benchmark --providers codex gemini
    modelmux benchmark --tasks code_review reasoning
    modelmux benchmark --output results.json
"""
